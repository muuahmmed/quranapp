...
Uri quranAppUrl = Uri.parse('https://github.com/muuahmmed');

Future saveSettings() async {
  final prefs = await SharedPreferences.getInstance();
  await prefs.setInt('arabicFontSize', arabicFontSize.toInt());
  await prefs.setInt('quranFontSize', quranFontSize.toInt());
}
...
Future getSettings() async {
  try {
    ...
    quranFontSize = prefs.getInt('quranFontSize')!.toDouble();
  } catch (e) {
    arabicFontSize = 28;
    quranFontSize = 40;
  }
